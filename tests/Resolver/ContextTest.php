...
class ContextTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(array('DE'), $context->getStoreRegistrations());
    ...
    {
        $this->context->setStoreRegistrations(array('DE', 'DK'));
        $this->assertEquals(array('DE', 'DK'), $this->context->getStoreRegistrations());
    }
